...
namespace SouthernClinicProject.Controllers
{
    public class PharmaciesController : Controller
    {
        ...
        public PharmaciesController(ClinicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pharmacies != null ? 
                          ...
                          Problem("Entity set 'ClinicContext.Pharmacies'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("PharmacyId,Name,Street,City,State,ZipCode")] Pharmacy pharmacy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PharmacyId,Name,Street,City,State,ZipCode")] Pharmacy pharmacy)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ClinicContext.Pharmacies'  is null.");
            }
            var pharmacy = await _context.Pharmacies.FindAsync(id);
            if (pharmacy != null)
            {
